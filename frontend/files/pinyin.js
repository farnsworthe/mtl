...
let pinyind = new Map(Object.entries(pinyin_data));

function callback(event){
  var chne = document.getElementById("chn").value;
  // alert(pinyind.get(chne) );
  document.getElementById("text").innerHTML=pinyind.get(chne);
  return false;
}
